...
PRODUCTS_DIR="$PROJECT_DIR/Products/$PROJECT_NAME"
...
case $PLATFORM_NAME in
	iphonesimulator)
		LIBRARY_FILENAME="lib${PROJECT_NAME}-simulator.a"
		;;

	iphoneos)
		LIBRARY_FILENAME="lib${PROJECT_NAME}-device.a"
		;;
		
	*)
		LIBRARY_FILENAME="lib${PROJECT_NAME}-${PLATFORM_NAME}.a"
		;;
esac
